...
mod tests {
  ...
  fn test_default_settings() {
    ...
    let expected = models::settings::Settings {
      ...
      language: services::language_service::get_default_language(),
      ...
      line_graph_color: models::settings::LineGraphColorSettings {
        cpu: [75, 192, 192],
        memory: [255, 99, 132],
        gpu: [255, 206, 86],
      },
  ...
  fn test_set_display_targets() {
    let mut settings = models::settings::Settings::default();
    let targets = vec![enums::hardware::HardwareType::Gpu, enums::hardware::HardwareType::Memory];
  ...
  fn test_set_line_graph_color() {
    ...
    assert!(
      settings
        .set_line_graph_color(enums::hardware::HardwareType::Cpu, new_color.clone())
        .is_ok()
    );
  ...
  fn test_set_invalid_line_graph_color() {
    ...
    assert!(
      settings
        .set_line_graph_color(enums::hardware::HardwareType::Cpu, invalid_color)
        .is_err()
    );
  }
  ...
  fn test_set_line_graph_color_invalid() {
    ...
    assert!(
      settings
        .set_line_graph_color(enums::hardware::HardwareType::Cpu, new_color)
        .is_err()
    );
  }
