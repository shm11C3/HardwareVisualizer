...
| [`superio-ite-it86xx-it87xx.md`](superio-ite-it86xx-it87xx.md) | ITE Environment Controller discovery and read-only motherboard temperatures. Rev 1 is implementation-ready only for exact raw chip ID `0x8728` / IT8728F/EX generic `TMPIN1`-`TMPIN3`, enabled as Experimental pending a user-submitted hardware dump. FAN1-5, voltages, controls, physical labels, and every other IT86xx/IT87xx ID remain disabled or unsupported. | Phase 4 | Implementation-ready (rev 1) |
