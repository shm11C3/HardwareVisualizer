...
/// The deliberate divergence, for this table too - see
/// `duckdb_data_archive::compare_an_unreadable_timestamp` for why refusing is
/// preferred to SQLite's silent omission.
